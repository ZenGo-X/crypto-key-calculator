...
inline void check(int pos){
	...
	int ed=std::min(pos+500000,num+1);
	int ac[65],rj[65];
...
emcc -pthread wallet_gen_deterministic_optimized.cpp -o wallet_gen_deterministic_optimized.wasm -s USE_PTHREADS -s IMPORTED_MEMORY -s TOTAL_MEMORY=134217728 -O3 --std=c++11
*/
